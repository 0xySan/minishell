...
/*   Updated: 2025/02/27 17:42:39 by etaquet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_relative_path(char *pwd, char **env)
{
	...
	if (!home)
		return (ft_strjoin_join("\001\033[1;32m\002 ",
				pwd, ": \001\033[0m\002"));
	...
	if (home_len > pwd_len || ft_strncmp(home, pwd, home_len) != 0)
		return (ft_strjoin_join("\001\033[1;32m\002 ",
				pwd, ": \001\033[0m\002"));
	t_path = ft_strjoin_join("~", pwd + home_len, ": \001\033[0m\002");
	r_path = ft_strjoin("\001\033[1;32m\002 ", t_path);
	free(t_path);
	return (r_path);
}
